		...
		<!-- galerie faune 1-->
			...
			<div class="row">
           		...
           		<div class=" col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
					<div class="conteneur">
	               		<table class="tableauvignette">
							<tr>
								<td><a href="../image/faune/hermine.php">	<img src="../image/faune/vignette_faune/hermine.jpg" alt="une hermine" title="une hermine"/></td>
								<td><a href="../image/faune/buse_variable.php">	<img src="../image/faune/vignette_faune/buse_variable.jpg" alt="une buse variable" title="une buse variable"/></td>
								<td><a href="../image/faune/cygne_tubercule.php">	<img src="../image/faune/vignette_faune/cygne_tubercule.jpg" alt="un cygne tuberculé" title="un cygne tuberculé"/></td>
							</tr>
						</table>
					</div>
           		</div>
